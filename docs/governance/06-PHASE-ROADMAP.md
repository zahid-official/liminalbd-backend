...
> Detailed tasks and execution state belong in the corresponding file under `docs/governance/phases/`.
...
- Phase transitions follow [05-TASK-WORKFLOW.md](05-TASK-WORKFLOW.md) and require explicit human approval.
...
- `docs/governance/phases/phase-2-auth-rbac.md` is human-approved with 26 executable tasks. `P2-T003` and `P2-T004` are retired from Phase 2 because Docker and Jest are deferred to project-completion tooling work under `DEC-013`. Logging is no longer deferred: Pino was adopted immediately under `DEC-024`; Winston is permanently dropped.
- Phase 2 is `ACTIVE / READY`. Tasks `P2-T028`, `P2-T001`, `P2-T002`, `P2-T005`, `P2-T006`, `P2-T007`, `P2-T008`, `P2-T009`, `P2-T010`, `P2-T011`, `P2-T012`, `P2-T013`, and `P2-T014` are `✅ Done`.
...
- the phase file, [MEMORY.md](MEMORY.md), [DECISIONS.md](DECISIONS.md) and this roadmap are consistent;
...
Do not assign a phase number, name, executable status or task breakdown to a future product area until its PRD requirements, ERD impact and phase boundaries are approved (following PRD Phase-Wise Scope Evolution).

For approved future scope:

1. create a phase file from `docs/governance/phases/_template.md`;
